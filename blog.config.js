...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '木木哥', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '待退休老干部', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.0010e.com', // 网站地址
